...
namespace NezamEquipment.ServiceLayer._Identity.SignIn
{
    public interface ISignInManager: IDisposable
    {
        ...
        /// <param name="user"/>
        /// <returns/>
        Task<ClaimsIdentity> CreateUserIdentityAsync(DomainClasses.Identity.User user);
        ...
        /// <returns/>
        Task SignInAsync(DomainClasses.Identity.User user, bool isPersistent, bool rememberBrowser);
