...
namespace MyCommon.Helpers.Helper
{
    ...
    {
        public static DefaultUlForExtension DefaultUlFor<TModel>(this HtmlHelper<TModel> htmlHelper, object haveAccessTo)
        {
    ...
    public class DefaultUlForExtension
    {
        ...
        public DefaultUlForExtension(object haveAccessTo)
        {
        ...
        public MvcHtmlString Done()
        {
            ...
            if (Options.DefaultUlForItems.Any())
            {
                ...
                {
                    var haveAccessTo = Options.HaveAccessTo.Check("Admin", defaultUlForItem.AjaxHaveAccessToController, defaultUlForItem.AjaxHaveAccessToAction);
                    if (!haveAccessTo)
                    {
                        continue;
                    }
