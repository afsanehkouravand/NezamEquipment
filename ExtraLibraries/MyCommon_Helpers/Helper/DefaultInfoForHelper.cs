...
namespace MyCommon.Helpers.Helper
{
    ...
    public class DefaultInfoForData
    {
        ...
        /// <summary>
        /// تغییر رنگ جدول بر اساس مقدار مدل
        /// </summary>
        /// <typeparam name="TModel"></typeparam>
        /// <typeparam name="TProperty"></typeparam>
        /// <param name="model"></param>
        /// <param name="expression"></param>
        /// <param name="colorRoles"></param>
        /// <returns></returns>
        public DefaultInfoForData SetColor<TModel, TProperty>
        (TModel model, Expression<Func<TModel, TProperty>> expression, IDictionary<string, DefaultInfoForColorType> colorRoles)
        {
            if (colorRoles == null)
                return this;
        ...
        /// <param name="setAuthorize"></param>
        /// <param name="haveAccessTo"></param>
        /// <returns></returns>
        ...
        /// <param name="gotopage">هدایت به صفحه دیگر</param>
        /// <returns></returns>
        public DefaultInfoForData SetFooterButton(string haveAccessToContrller, string haveAccessToAction, string text, Dictionary<string, string> htmlAttributes, string gotopage = null)
        {
            Options.EnablePanelFooter = true;
            var m = new DefaultInfoForOptions.Button()
            {
            ...
            {
                if (m.HtmlAttributes == null)
                {
                    m.HtmlAttributes = new Dictionary<string, string>()
                    {
                ...
                {
                    m.HtmlAttributes.Add("data-gotopage", gotopage);
                }
            }
            Options.PanelFooterButtons.Add(m);
            return this;
        }
