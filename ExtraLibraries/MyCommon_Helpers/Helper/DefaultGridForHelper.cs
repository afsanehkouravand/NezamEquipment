...
//                haveAccessTo = datahaveAccessTo.GetValue(model, null);
...
//        public DefaultGridForExtension(HtmlHelper htmlHelper, object model, IEnumerable<object> listOfData, object haveAccessTo, string title, DefaultGridForColorType color)
//        {
...
//            divPanelHeading.InnerHtml = Options.Title + "<i id=\"tableLoading" + tableLoadingRandom + "\" class=\"fa fa-refresh fa-spin\" style=\"margin-right:10px; display:none;\"></i>";
...
//                        {
//                            haveAccessTo =
//                                Options.HaveAccessTo.Check("Admin", item.HaveAccessToContrller, item.HaveAccessToAction);
//                        }
//                        if (haveAccessTo)
//                        {
//                            var a = new TagBuilder("a");
...
//                            if (item.IsBoolean)
//                            {
//                                if (propertValue != null && propertValue as string != "-")
//                                {
...
//                        if (Options.SetAuthorize)
//                        {
//                            haveAccessTo = Options.HaveAccessTo.Check("Admin", item.HaveAccessToContrller, item.HaveAccessToAction);
//                        }
//                        if (haveAccessTo)
//                        {
...
//                if (Options.SetAuthorize)
//                {
//                    haveAccessTo = Options.HaveAccessTo.Check("Admin", Options.FormHaveAccessToController,
...
//                    if (!string.IsNullOrWhiteSpace(Options.FormGoToPage))
//                    {
//                        form.MergeAttribute("data-gotopage", Options.FormGoToPage);
...
//        /// <param name="gotopage">رفتن به صفحه خاص بعد از موفقیت عملیات</param>
//        /// <returns></returns>
//        public DefaultGridForData SetForm(string haveAccessToContrller, string haveAccessToAction, string url,
//            Dictionary<string, string> hiddenInput = null, string gotopage = null)
//        {
...
//        public string FormGoToPage { get; set; }
