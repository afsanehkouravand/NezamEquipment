...
namespace NezamEquipment.Common.DbCommand
{
    public class YeKeInterceptor : IDbCommandInterceptor
    {
        public void ReaderExecuting(System.Data.Common.DbCommand command, DbCommandInterceptionContext<DbDataReader> interceptionContext)
        {
        ...
        public void ReaderExecuted(System.Data.Common.DbCommand command, DbCommandInterceptionContext<DbDataReader> interceptionContext)
        {
        }
    ...
    public static class YeKe
    {
        ...
        public static void ApplyCorrectYeKe(this System.Data.Common.DbCommand command)
        {
