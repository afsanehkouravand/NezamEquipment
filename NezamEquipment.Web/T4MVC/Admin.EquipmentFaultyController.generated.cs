...
{
    public partial class EquipmentFaultyController
    {
        [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
        protected EquipmentFaultyController(Dummy d) { }
        ...
        [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
        public EquipmentFaultyController Actions { get { return MVC.Admin.EquipmentFaulty; } }
        [GeneratedCode("T4MVC", "2.0")]
        public readonly string Area = "Admin";
        [GeneratedCode("T4MVC", "2.0")]
        public readonly string Name = "EquipmentFaulty";
        [GeneratedCode("T4MVC", "2.0")]
        public const string NameConst = "EquipmentFaulty";
        [GeneratedCode("T4MVC", "2.0")]
        ...
        {
            public readonly string id = "id";
            public readonly string dto = "EquipmentFaultyDto";
        ...
        {
            public readonly string id = "id";
            public readonly string applicantDto = "EquipmentFaultyDto";
        }
    ...
    [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
    public partial class T4MVC_EquipmentFaultyController : NezamEquipment.Web.Areas.Admin.Features.EquipmentFaulty.EquipmentFaultyController
    {
        public T4MVC_EquipmentFaultyController() : base(Dummy.Instance) { }
        ...
        [NonAction]
        partial void AddOverride(T4MVC_System_Web_Mvc_ActionResult callInfo, System.Guid id);

        [NonAction]
        public override System.Threading.Tasks.Task<System.Web.Mvc.ActionResult> Add(System.Guid id)
        {
            var callInfo = new T4MVC_System_Web_Mvc_ActionResult(Area, Name, ActionNames.Add);
            ModelUnbinderHelpers.AddRouteValues(callInfo.RouteValueDictionary, "id", id);
        ...
        [NonAction]
        partial void AddOverride(T4MVC_System_Web_Mvc_JsonResult callInfo, NezamEquipment.ServiceLayer.Entity.EquipmentFaulty.Dto.EquipmentFaultyDto dto, System.Guid equipmentId, NezamEquipment.ServiceLayer.OtherServices.Upload.Dto.UploadByBase64Dto uploadByBase64);

        [NonAction]
        public override System.Threading.Tasks.Task<System.Web.Mvc.JsonResult> Add(NezamEquipment.ServiceLayer.Entity.EquipmentFaulty.Dto.EquipmentFaultyDto dto, System.Guid equipmentId, NezamEquipment.ServiceLayer.OtherServices.Upload.Dto.UploadByBase64Dto uploadByBase64)
        {
            var callInfo = new T4MVC_System_Web_Mvc_JsonResult(Area, Name, ActionNames.Add);
            ModelUnbinderHelpers.AddRouteValues(callInfo.RouteValueDictionary, "EquipmentFaultyDto", dto);
            ModelUnbinderHelpers.AddRouteValues(callInfo.RouteValueDictionary, "equipmentId", equipmentId);
            ModelUnbinderHelpers.AddRouteValues(callInfo.RouteValueDictionary, "UploadByBase64", uploadByBase64);
            AddOverride(callInfo, dto, equipmentId, uploadByBase64);
            return System.Threading.Tasks.Task.FromResult(callInfo as System.Web.Mvc.JsonResult);
        }
        ...
        [NonAction]
        partial void EditOverride(T4MVC_System_Web_Mvc_JsonResult callInfo, NezamEquipment.ServiceLayer.Entity.EquipmentFaulty.Dto.EquipmentFaultyDto applicantDto);

        [NonAction]
        public override System.Threading.Tasks.Task<System.Web.Mvc.JsonResult> Edit(NezamEquipment.ServiceLayer.Entity.EquipmentFaulty.Dto.EquipmentFaultyDto applicantDto)
        {
            var callInfo = new T4MVC_System_Web_Mvc_JsonResult(Area, Name, ActionNames.Edit);
            ModelUnbinderHelpers.AddRouteValues(callInfo.RouteValueDictionary, "EquipmentFaultyDto", applicantDto);
