...
namespace NezamEquipment.Web.Areas.Admin.Features.Account
{
    ...
    [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
    public partial class T4MVC_AccountController : NezamEquipment.Web.Areas.Admin.Features.Account.AccountController
    {
        ...
        [NonAction]
        partial void LoginOverride(T4MVC_System_Web_Mvc_ActionResult callInfo, NezamEquipment.Web.Areas.Admin.Features.Account.LoginViewModel model, bool captchaValid);

        [NonAction]
        public override System.Threading.Tasks.Task<System.Web.Mvc.ActionResult> Login(NezamEquipment.Web.Areas.Admin.Features.Account.LoginViewModel model, bool captchaValid)
        {
            var callInfo = new T4MVC_System_Web_Mvc_ActionResult(Area, Name, ActionNames.Login);
            ModelUnbinderHelpers.AddRouteValues(callInfo.RouteValueDictionary, "model", model);
            ModelUnbinderHelpers.AddRouteValues(callInfo.RouteValueDictionary, "captchaValid", captchaValid);
            LoginOverride(callInfo, model, captchaValid);
