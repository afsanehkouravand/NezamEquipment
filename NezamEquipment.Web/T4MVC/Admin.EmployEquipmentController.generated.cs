...
{
    public partial class EmployEquipmentController
    {
        [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
        protected EmployEquipmentController(Dummy d) { }
        ...
        [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
        public EmployEquipmentController Actions { get { return MVC.Admin.EmployEquipment; } }
        [GeneratedCode("T4MVC", "2.0")]
        public readonly string Area = "Admin";
        [GeneratedCode("T4MVC", "2.0")]
        public readonly string Name = "EmployEquipment";
        [GeneratedCode("T4MVC", "2.0")]
        public const string NameConst = "EmployEquipment";
        [GeneratedCode("T4MVC", "2.0")]
    ...
    [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
    public partial class T4MVC_EmployEquipmentController : NezamEquipment.Web.Areas.Admin.Features.EmployEquipment.EmployEquipmentController
    {
        public T4MVC_EmployEquipmentController() : base(Dummy.Instance) { }
