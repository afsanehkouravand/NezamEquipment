...
namespace NezamEquipment.Web.Areas.Admin.Features.Profile
{
    ...
    [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
    public partial class T4MVC_ProfileController : NezamEquipment.Web.Areas.Admin.Features.Profile.ProfileController
    {
        ...
        [NonAction]
        partial void EditOverride(T4MVC_System_Web_Mvc_JsonResult callInfo, NezamEquipment.ServiceLayer._Identity.User.Dto.UserDto userDto);

        [NonAction]
        public override System.Threading.Tasks.Task<System.Web.Mvc.JsonResult> Edit(NezamEquipment.ServiceLayer._Identity.User.Dto.UserDto userDto)
        {
