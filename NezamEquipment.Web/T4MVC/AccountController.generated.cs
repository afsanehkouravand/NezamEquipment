...
namespace NezamEquipment.Web.Controllers
{
    ...
    [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
    public partial class T4MVC_AccountController : NezamEquipment.Web.Controllers.AccountController
    {
        ...
        [NonAction]
        public override System.Threading.Tasks.Task<System.Web.Mvc.ActionResult> Login(string username, string password)
        {
            var callInfo = new T4MVC_System_Web_Mvc_ActionResult(Area, Name, ActionNames.Login);
